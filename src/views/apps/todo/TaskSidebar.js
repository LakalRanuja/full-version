...
const TaskSidebar = props => {
  ...
  const [title, setTitle] = useState(''),
    ...
    [grade, setGrade] = useState({ value: '1', label: '1'}),
  ...
  const grades = [
    ...
    { value: '10', label: '10' },
    { value: '11', label: '11' },
    { value: '12 - Bio,Chemistry,Physics', label: '12 - Bio,Chemistry,Physics'},
    { value: '12 - Mathematics,Physics', label: '12 - Mathematics,Physics'},
    { value: '12 - Bio-Tec,SFT,ICT', label: '12 - Bio-Tec,SFT,ICT'},
    { value: '13 - Bio,Chemistry,Physics', label: '13 - Bio,Chemistry,Physics'},
    { value: '13 - Mathematics,Physics', label: '13 - Mathematics,Physics'},
    { value: '13 - Bio-Tec,SFT,ICT', label: '13 - Bio-Tec,SFT,ICT'}
  ]
